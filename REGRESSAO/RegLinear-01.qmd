...
Entende-se como **melhor reta** aquela que apresenta a somatória dos resíduos deve ser igual à zero e a somatória dos resíduos ao quadrado for a mínima possível (Mean Square Error - MSE).
...
fr <- function(x){
  alpha <- x[1]
  beta1 <- x[2]
  mean((df$mpg - (alpha + beta1 * df$hp))^2)
}
optim(par = c(0,0), fn = fr)
```
